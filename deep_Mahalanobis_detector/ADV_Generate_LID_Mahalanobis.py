...
parser.add_argument('--net_type', required=True, help='resnet18 | resnet | densenet')
...
def main():
    ...
    train_loader, _ = data_loader.getTargetDataSet(args.dataset, args.batch_size, None, args.dataroot)
